...
export const wowdbPriestSkillsComplete = {
  "baseline": {
    "17": { "name": "Power Word: Shield", "kr": "신의 권능: 보호막", "level": 1, "type": "ability" },
    "139": { "name": "Renew", "kr": "소생", "level": 1, "type": "ability" },
    "527": { "name": "Purify", "kr": "정화", "level": 1, "type": "ability" },
    "585": { "name": "Smite", "kr": "성스러운 일격", "level": 1, "type": "ability" },
    "2060": { "name": "Heal", "kr": "치유", "level": 1, "type": "ability" },
    "2061": { "name": "Flash Heal", "kr": "순간 치유", "level": 1, "type": "ability" }
  },
  "holy": {
    "2050": { "name": "Holy Word: Serenity", "kr": "신성한 언령: 평온", "level": 10, "type": "ability" },
    "34861": { "name": "Holy Word: Sanctify", "kr": "신성한 언령: 성화", "level": 10, "type": "ability" },
    "64843": { "name": "Divine Hymn", "kr": "천상의 찬가", "level": 10, "type": "ability" }
  },
  "shadow": {
    "8092": { "name": "Mind Blast", "kr": "정신 분열", "level": 10, "type": "ability" },
    "15407": { "name": "Mind Flay", "kr": "정신 채찍", "level": 10, "type": "ability" },
    "32379": { "name": "Shadow Word: Death", "kr": "어둠의 권능: 죽음", "level": 10, "type": "ability" },
    "228260": { "name": "Void Eruption", "kr": "공허 분출", "level": 10, "type": "ability" }
  },
  "discipline": {
    "47536": { "name": "Rapture", "kr": "환희", "level": 10, "type": "ability" },
    "47540": { "name": "Penance", "kr": "고해", "level": 10, "type": "ability" },
    "194509": { "name": "Power Word: Radiance", "kr": "신의 권능: 광휘", "level": 10, "type": "ability" }
  },
  "heroTalents": {
    "447444": { "name": "Entropic Rift", "kr": "엔트로피 균열", "tree": "Voidweaver", "level": 70, "type": "heroTalent" },
    "449882": { "name": "Premonition", "kr": "예감", "tree": "Oracle", "level": 70, "type": "heroTalent" },
    "453570": { "name": "Perfected Form", "kr": "완성된 형태", "tree": "Archon", "level": 70, "type": "heroTalent" }
  },
  "talents": {
...
export function getWowDBPriestSkill(skillId) {
  ...
  for (const category of categories) {
    if (wowdbPriestSkillsComplete[category]?.[skillId]) {
      return { ...wowdbPriestSkillsComplete[category][skillId], category, id: skillId };
    }
  }
  return null;
}
