...
function getInlineChartPlan(guide, data) {
  ...
  if (guide.id === 'rogue-outlaw') {
    plan.push({
      ...
      caption:
        '이 막대는 WCL 타임라인을 그대로 옮긴 것이 아니라 로그를 읽는 순서입니다. 먼저 마무리 기술 빈도와 연계 점수 과충전을 보고, 그 다음 미간 적중 지연, 아드레날린 촉진과 준비 되감기, 폭풍의 칼날 다중 대상 적중, 무형검/최후의 일격 또는 운명의 손/행운 주화 분기를 확인합니다.',
      definition: [
        ['의미', '잠들지 않는 칼날은 무법의 중심 피드백입니다. 연계 점수 소비가 끝이 아니라 다음 쿨기 구간을 앞당기는 시작점입니다.'],
    ...
    return [
      {
        ...
        note: '5~6점 마무리 기술이 다음 쿨기 구간을 앞당기는 무법의 중심 피드백입니다.',
  ...
  if (guide.id === 'warlock-demonology') {
    return [
      ...
      },
      {
        ...
        note: '다중 대상 또는 큰 구간에서 별도 피해 축으로 확인합니다.',
