...
function getInlineChartPlan(guide, data) {
  const plan = [
    {
      ...
      caption: '위 설명에서 다룬 첫 전투 흐름, 진입, 피해 대응 판단을 시간 흐름으로 정리한 차트입니다.',
    },
    {
      id: 'priority',
      title: '우선순위 판단',
  ...
  if (guide.id === 'warlock-affliction') {
    plan.push({
      ...
      sectionHeading: '지속 피해와 조각 소비 구간',
      sectionIntro:
        '고통 흑마법사는 고통과 부패를 유지하면서 불안정한 고통과 부패의 씨앗으로 영혼의 조각을 비우고, 암흑의 수확과 암흑시선 소환을 그 위에 겹칩니다.',
      caption:
        '막대는 실제 WCL 초 단위 복사본이 아니라 고통, 부패, 불안정한 고통, 유령 출몰, 암흑의 수확, 암흑시선 소환, 부패의 씨앗 전환을 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ...
        ['체크 포인트', '고통/부패 누락, 불안정한 고통 비활성, 5조각 과충전, 암흑의 수확 지연, 암흑시선 소환 전 지속 피해 부족을 함께 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'warlock-demonology') {
    plan.push({
      ...
      sectionHeading: '소환수 수명과 폭군 타이밍',
      sectionIntro:
        '악마 흑마법사는 영혼의 조각을 소환수 수명으로 바꾼 뒤 악마 폭군 소환으로 그 수명을 피해 구간에 묶습니다. 이 차트는 굴단의 손, 공포사냥개 부르기, 악마의 핵, 흑마법서 계열, 파멸수호병 소환, 파열이 어떤 순서로 겹쳐야 하는지 보여 줍니다.',
      caption:
        '막대는 실제 WCL 초 단위 복사본이 아니라 조각 준비, 공포사냥개 부르기, 굴단의 손 임프 생성, 큰 악마 쿨다운, 악마 폭군 소환, 파열 광역 전환을 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ['의미', '악마 폭군 소환은 독립 쿨다운이 아니라 직전 소환수 수명과 조각 준비 상태를 검사하는 중심 타이밍입니다.'],
        ['읽는 법', '폭군 전에는 공포사냥개 부르기와 굴단의 손으로 재료를 만들고, 폭군 중에는 악마의 핵과 악마 화살로 조각을 복구해 후속 굴단의 손을 이어갑니다.'],
        ['체크 포인트', '낮은 조각 굴단의 손, 공포사냥개 부르기 지연, 악마의 핵 과충전, 소환수 없는 악마 폭군 소환, 임프 수 부족 파열을 함께 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'warlock-destruction') {
    plan.push({
      ...
      sectionIntro:
        '파괴 흑마법사는 유지 주문으로 조각 관리를 시작하고, 점화와 소각으로 만든 영혼의 조각을 혼돈의 화살, 대혼란, 불의 비 중 어디에 쓸지 고르는 전문화입니다.',
      caption:
        '막대는 실제 WCL 초 단위 복사본이 아니라 제물/쇠퇴 유지, 점화와 역류, 혼돈의 화살, 대혼란, 불의 비, 지옥불정령 소환을 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ['의미', '혼돈의 화살은 단일 소모기이고, 불의 비는 대상 수와 생존 시간이 맞을 때 쓰는 광역 소비기입니다.'],
        ['읽는 법', '유지 주문이 비면 먼저 복구하고, 조각이 넘치기 전 단일은 혼돈의 화살, 2대상은 대혼란 중 혼돈의 화살, 광역은 불의 비로 전환합니다.'],
        ['체크 포인트', '제물/쇠퇴 공백, 점화 2충전 방치, 역류가 긴 시전과 어긋난 구간, 대혼란 중 비는 구간, 불의 비 적중 시간 부족을 함께 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'monk-brewmaster') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 초 단위 복사본이 아니라 시간차 위험도, 정화주, 천신주, 맥주통 휘두르기, 후려차기, 흑우 니우짜오의 원령을 한 화면에 묶은 방어 확인용 흐름도입니다.',
      definition: [
        ...
        ['체크 포인트', '높은 시간차 방치, 낮은 시간차 정화주 낭비, 천신주 지연, 맥주통 휘두르기 지연, 흑우 니우짜오의 원령이 빈 구간에 들어간 상황을 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'monk-windwalker') {
    plan.push({
      id: 'uptime',
      title: '기-쿨기 몰아넣기 타임라인',
      sectionHeading: '분노의 주먹과 자원 잠금',
      sectionIntro:
        '풍운 수도사는 기력과 기를 과충전하지 않으면서 같은 기술 반복 금지 규칙을 지키고, 분노의 주먹과 해오름차기 같은 짧은 쿨기를 밀리지 않게 굴리는 근접 딜러입니다.',
      caption:
        '막대는 실제 WCL 초 단위 복사본이 아니라 기 생성, 기 소비, 분노의 주먹 채널, 정점/호안주, 폭풍과 대지와 불, 백호 쉬엔의 원령, 광역 전환을 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ['의미', '분노의 주먹은 풍운의 가장 중요한 채널 기술이고, 해오름차기와 바람의 군주의 일격은 밀리면 손실이 큰 짧은 쿨기입니다. 회전 학다리차기는 대상 수가 충분할 때만 올라오는 광역 선택지입니다.'],
        ['읽는 법', '범의 장풍으로 기를 만들고, 기가 넘치기 전에 후려차기나 핵심 소모기로 비우되, 분노의 주먹과 해오름차기 쿨다운을 밀지 않습니다.'],
        ['체크 포인트', '기 과충전, 기력 과충전, 같은 기술 반복, 분노의 주먹 채널 끊김, 해오름차기 지연, 회전 학다리차기 대상 수 오류를 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'monk-mistweaver') {
    plan.push({
      ...
      sectionHeading: '소생의 안개와 피해 복구 구간',
      sectionIntro:
        '운무 수도사는 피해 전에 소생의 안개 대상을 충분히 만들고, 피해 예고에 맞춰 생기 충전, 마나 차, 천신합일, 재활, 기의 고치를 분산하는 힐러입니다.',
      caption:
        '이 막대는 HPS 수치표가 아니라 소생의 안개 대상 유지, 생기 충전 복구, 근접 치유 엔진, 마나 차, 단일 대상 외부 생존기, 대형 공대 쿨기를 한눈에 모은 힐러 흐름도입니다.',
      definition: [
        ['의미', '소생의 안개는 생기 충전이 여러 대상에게 퍼질 준비를 만들고, 생기 충전은 피해가 들어온 뒤 소생이 걸린 대상을 통해 회수하는 핵심 주문입니다.'],
        ['읽는 법', '피해 전에는 소생의 안개와 마나 차를 준비하고, 피해 직후에는 생기 충전 또는 재활/천신합일을 배정하며, 단일 대상 위험은 포용의 안개와 기의 고치로 분리합니다.'],
        ['체크 포인트', '소생의 안개 충전 과충전, 생기 충전이 닿을 소생 대상 부족, 마나 차 스택 방치, 질풍차기 근접 공백, 재활/천신합일 중복, 기의 고치 지연을 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'warrior-protection') {
    plan.push({
      ...
      sectionIntro:
        '방어 전사는 받은 피해 총합보다 방패 올리기가 실제로 맞는 시간에 켜져 있었는지가 먼저입니다. 이 차트는 방패 올리기 유효 유지율, 방패 밀쳐내기 분노 생성, 고통 감내 흡수막, 주문 반사와 주요 생존기 배정을 한 줄 시간표로 묶어 보여줍니다.',
      caption:
        '이 막대는 WCL 타임라인을 그대로 베낀 것이 아니라 로그를 볼 때의 확인 순서입니다. 먼저 방패 올리기 공백을 보고, 그 공백에 고통 감내·주문 반사·사기의 외침·방패의 벽이 덮였는지 확인한 뒤 산왕 또는 거신 피해 구간을 읽습니다.',
      definition: [
        ['의미', '방패 올리기는 중심 방어 상태이고, 방패 밀쳐내기와 천둥벼락은 다음 방어 행동을 여는 분노 엔진입니다.'],
        ['읽는 법', '상단 방패 시간이 비어 있는 곳에서 실제 근접 피해를 맞았는지 확인하고, 그 아래 흡수막과 생존기 배정이 이어지는지 봅니다.'],
        ['체크 포인트', '방패 올리기 유효 유지율, 고통 감내 낭비, 주문 반사 누락, 복수 과다 소비, 생존기 중복 사용을 순서대로 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'warrior-arms') {
    plan.push({
      id: 'uptime',
      title: '필사의 일격-피해 구간 타임라인',
      sectionHeading: '필사의 일격과 피해 구간 맞추기',
      sectionIntro:
        '무기 전사는 필사의 일격을 중심으로 거인의 강타 또는 전쟁파괴자 구간, 제압 충전, 마무리 일격 전환, 칼날폭풍 또는 쇄파를 맞춥니다. 이 타임라인은 단일 피해 구간과 광역 선택이 어느 순간에 갈라지는지 보여줍니다.',
      caption:
        '막대는 실제 WCL 초 단위 복사본이 아니라 로그를 읽는 순서입니다. 필사의 일격 지연을 먼저 보고, 그 앞뒤로 거인의 강타/전쟁파괴자, 제압 충전, 분쇄/죽음의 상처, 학살자 칼날폭풍, 거신 쇄파가 맞물렸는지 확인합니다.',
      definition: [
        ['의미', '필사의 일격은 중심 타격이고, 거인의 강타와 전쟁파괴자는 그 타격과 후속 강한 기술을 몰아넣는 피해 구간입니다.'],
        ['읽는 법', '상단의 필사의 일격 주기를 기준으로 제압 과충전, 마무리 일격 발동, 칼날폭풍 또는 쇄파 위치가 같은 구간에 들어오는지 봅니다.'],
        ['체크 포인트', '필사의 일격 지연, 거인의 강타 안 빈 글쿨, 제압 2충전 방치, 처형 구간 분노 고갈, 쇄파 위치 손실, 학살자 광역 제압 우선순위 오류를 함께 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'warrior-fury') {
    plan.push({
      id: 'uptime',
      title: '광란-격노 분노 관리 타임라인',
      sectionHeading: '광란과 격노 손실 구간',
      sectionIntro:
        '분노 전사는 광란을 중심으로 격노 상태, 분노 생성기, 무모한 희생/투신 구간, 학살자 또는 산왕 선택지를 동시에 읽어야 합니다. 이 타임라인은 광란이 언제 단순 소비기가 아니라 상태 전환과 광역 발동 조건이 되는지 보여줍니다.',
      caption:
        '막대는 실제 WCL 초 단위 복사본이 아니라 로그를 확인하는 순서입니다. 광란 지연과 격노 공백을 먼저 보고, 그 아래 피의 갈증, 분노의 강타, 무모한 희생, 투신, 우레 작렬, 소용돌이 연마, 학살자 마무리 일격/칼날폭풍이 같은 구간에 들어왔는지 확인합니다.',
      definition: [
        ['의미', '광란은 분노를 피해로 바꾸는 버튼이면서 격노를 켜고 12.0.5 학살자 광역 발동까지 연결하는 중심 노드입니다.'],
        ['읽는 법', '상단의 광란 주기를 기준으로 격노 공백, 분노 과충전, 생성기 지연, 무모한 희생/투신 구간, 우레 작렬 2중첩, 소용돌이 연마 공백을 차례대로 봅니다.'],
        ['체크 포인트', '광란 지연, 격노가 강화 구간에서 빠진 시간, 피의 갈증/분노의 강타 충전 낭비, 우레 작렬 과충전, 소용돌이 연마 없는 광역 광란, 학살자 칼날폭풍 지연을 함께 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'rogue-assassination') {
    plan.push({
      ...
      sectionHeading: '독살 구간과 출혈 기반',
      sectionIntro:
        '암살 도적은 목조르기와 파열 유지표만으로 설명하면 핵심을 놓칩니다. 이 타임라인은 독살을 중심으로 출혈 기반, 죽음표식과 왕의 파멸, 독칼과 부식성 분사, 운명의 손 또는 죽음추적자의 징표가 어떻게 같은 구간에 묶이는지 보여줍니다.',
      caption:
        '이 막대는 WCL 타임라인을 그대로 옮긴 것이 아니라 로그를 읽는 순서입니다. 먼저 목조르기와 파열이 죽음표식 전에 깔렸는지 보고, 그 다음 독살 구간이 왕의 파멸 14초 동안 비지 않았는지, 독칼과 부식성 분사, 혈폭풍 광역 복제가 올바른 대상에 들어갔는지 확인합니다.',
      definition: [
        ['의미', '독살은 연계 점수를 소비하는 마무리 기술이면서 독 발동 확률, 왕의 파멸 ramp, 운명의 손 동전 루프를 여는 중심 노드입니다.'],
        ['읽는 법', '상단의 독살 주기를 기준으로 목조르기/파열 공백, 죽음표식-왕의 파멸 정렬, 독칼, 부식성 분사, 혈폭풍 복제, 영웅 특성 보상을 차례대로 봅니다.'],
        ['체크 포인트', '죽음표식 대상 사망, 왕의 파멸 중 독살 공백, 5938 독칼과 185565 독 칼 혼동, 출혈 없는 혈폭풍, 표식 대상이 아닌 어둡고 어두운 밤 독살을 함께 잡습니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'rogue-outlaw') {
    plan.push({
      ...
      sectionHeading: '마무리 기술과 쿨기 환급',
      sectionIntro:
        '무법 도적은 생성기와 마무리 기술의 단순 반복이 아니라, 마무리 기술이 잠들지 않는 칼날을 통해 다음 아드레날린 촉진, 미간 적중, 폭풍의 칼날, 질풍 칼날, 광기의 학살자, 뼈주사위 구간을 앞당기는 구조입니다. 이 타임라인은 연계 점수 생성, 5~6점 소비, 뼈주사위 단계, 폭풍의 칼날 전환, 기만자와 운명결속 보정이 한 전투 안에서 어떻게 맞물리는지 보여줍니다.',
      caption:
        '이 막대는 WCL 타임라인을 그대로 옮긴 것이 아니라 로그를 읽는 순서입니다. 먼저 마무리 기술 빈도와 연계 점수 과충전을 보고, 그 다음 미간 적중 지연, 아드레날린 촉진과 준비 되감기, 폭풍의 칼날 다중 대상 적중, 무형검/최후의 일격 또는 운명의 손/행운 주화 선택지 차이를 확인합니다.',
      definition: [
        ['의미', '잠들지 않는 칼날은 무법의 쿨기 환급 구조입니다. 연계 점수 소비가 끝이 아니라 다음 쿨기 구간을 앞당기는 시작점입니다.'],
        ['읽는 법', '상단의 마무리 기술 주기를 기준으로 사악한 일격/권총 사격 생성, 미간 적중/속결 소비, 뼈주사위 단계, 준비 되감기, 폭풍의 칼날 확산, 영웅 특성 보정을 차례대로 봅니다.'],
        ['체크 포인트', '연계 점수 과충전, 기회 6중첩 방치, 미간 적중 지연, 준비 조기 사용, 폭풍의 칼날 없는 다중 대상, 최후의 일격 속결 지연, 행운 주화 중 마무리 기술 손실을 함께 잡습니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'rogue-subtlety') {
    plan.push({
      ...
      sectionHeading: '은밀한 기술과 어둠의 칼날 구간',
      sectionIntro:
        '잠행 도적은 어둠의 춤을 많이 쓰는 전문화가 아니라 은밀한 기술을 기준으로 어둠의 춤, 어둠의 칼날, 그림자 일격, 절개, 고대의 기술 후속 소비를 몰아넣는 전문화입니다. 이 타임라인은 90초 큰 구간 안에 첫 은밀한 기술, 두 번의 어둠의 춤, 기만자/죽음추적자 보정, 광역 전환이 어떤 관계로 들어가는지 보여줍니다.',
      caption:
        '이 막대는 WCL 타임라인을 그대로 옮긴 것이 아니라 로그를 읽는 순서입니다. 먼저 은밀한 기술이 어둠의 춤 안에 들어갔는지 보고, 그 다음 어둠의 칼날 안 두 번째 춤, 연계 점수 과충전, 표창 폭풍/검은 화약 전환, 최후의 일격 또는 죽음추적자의 징표 보상을 확인합니다.',
      definition: [
        ['의미', '은밀한 기술은 잠행 그래프의 중앙 마무리 기술이고, 어둠의 춤은 그 버튼을 넣는 짧은 구간입니다.'],
        ['읽는 법', '어둠의 칼날이 켜진 큰 구간 안에 첫 은밀한 기술과 두 번의 어둠의 춤이 들어갔는지를 가장 먼저 봅니다.'],
        ['체크 포인트', '기력 고갈, 연계 점수 과충전, 최후의 일격 절개 지연, 죽음추적자의 징표 대상 오류, 광역 전환 누락을 함께 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'shaman-elemental') {
    plan.push({
      id: 'uptime',
      title: '폭풍수호자-폭풍 몰아넣기 타임라인',
      sectionHeading: '폭풍수호자와 폭풍인도자 타이밍',
      sectionIntro:
        '정기 주술사는 화염 충격과 용암 폭발을 기반으로 하지만, 현재 구조의 중심은 폭풍수호자입니다. 이 타임라인은 화염 코어 정리, 폭풍수호자 강화 주문, 폭풍 발동, 승천, 소용돌이 소비, 이동 보존, 쐐기 유틸을 한 줄에 묶어 강화 구간 전후의 판단 순서를 보여줍니다.',
      caption:
        '막대는 실제 로그 초 단위 복사본이 아니라 확인 순서입니다. 먼저 화염 충격/용암 폭발/소용돌이 상태를 정리하고, 그 다음 폭풍수호자 강화 번개 화살 또는 연쇄 번개, 폭풍, 대지 충격/정기 작렬/지진, 이동 보존과 차단을 확인합니다.',
      definition: [
        ['의미', '폭풍수호자는 강화 자연 주문을 여는 버튼이면서 폭풍인도자 폭풍 흐름, 승천 구간, 소용돌이 소비 선택을 한꺼번에 묶는 중심 노드입니다.'],
        ['읽는 법', '상단의 폭풍수호자 줄을 기준으로 화염 충격 유지와 용암 폭발 충전이 준비됐는지, 폭풍과 강화 주문이 낭비 없이 들어갔는지, 단일/광역 소비기가 올바르게 갈렸는지 봅니다.'],
        ['체크 포인트', '화염 충격 공백, 용암 폭발 충전 낭비, 소용돌이 과충전, 폭풍수호자 강화 주문 미소비, 폭풍 방치, 이동 중 큰 구간 손실, 날카로운 바람 누락을 함께 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'shaman-restoration') {
    plan.push({
      id: 'uptime',
      title: '성난 해일-피해 복구 타임라인',
      sectionHeading: '성난 해일과 공대 쿨기 배정',
      sectionIntro:
        '복원 주술사는 고정 딜사이클이 아니라 피해 예고에 맞춰 성난 해일 대상, 치유의 비/쇄도하는 토템 위치, 폭우와 연쇄 치유 회수, 치유의 해일 토템/승천/정신의 고리 토템 배정을 겹치는 힐러입니다.',
      caption:
        '이 막대는 HPS 타임라인을 그대로 베낀 것이 아니라 로그 확인 순서입니다. 먼저 성난 해일이 묻은 대상과 위치 기반 힐을 보고, 그 다음 폭우/연쇄 치유 회수, 큰 공대 쿨기, 차단/해제를 확인합니다.',
      definition: [
        ['의미', '성난 해일은 복원 그래프의 중앙 표식이고, 연쇄 치유와 치유의 물결은 그 표식을 실제 회복으로 바꾸는 복구 주문입니다.'],
        ['읽는 법', '피해 전에는 물의 보호막, 대지의 보호막, 성난 해일, 치유의 비 또는 쇄도하는 토템을 준비하고, 피해 직후에는 폭우와 연쇄 치유로 회수합니다.'],
        ['체크 포인트', '성난 해일 대상 중복, 쇄도하는 토템 위치 손실, 폭우 지연, 연쇄 치유 첫 대상 오류, 정신의 고리 토템 사후 사용, 날카로운 바람 누락을 함께 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'shaman-enhancement') {
    plan.push({
      ...
      sectionHeading: '소용돌이 소비와 영웅 특성 선택지',
      sectionIntro:
        '고양 주술사는 소용돌이치는 무기를 비운 뒤 정기의 속도로 돌아온 폭풍의 일격과 용암 채찍을 다시 굴리는 전문화입니다. 이 타임라인은 소용돌이 소비, 낙뢰 강화, 토템술사 1분 구간, 폭풍인도자 폭풍 구간, 쐐기 유틸을 한 화면에서 분리해 보여줍니다.',
      caption:
        '막대는 실제 WCL 초 단위 복사본이 아니라 로그 확인 순서입니다. 먼저 소용돌이치는 무기 과충전과 소비 간격을 보고, 그 다음 폭풍의 일격/용암 채찍 환급, 낙뢰 광역 전환, 쇄도하는 토템 또는 폭풍 구간을 확인합니다.',
      definition: [
        ['의미', '소용돌이치는 무기는 고양의 중심 노드입니다. 소비는 피해 주문이면서 정기의 속도 환급을 통해 다음 근접 타격기를 여는 행동입니다.'],
        ['읽는 법', '상단의 소용돌이 소비 줄을 기준으로 단일 번개 화살, 광역 연쇄 번개, 낙뢰 강화, 토템술사/폭풍인도자 구간이 같은 시간에 맞는지 봅니다.'],
        ['체크 포인트', '9~10중첩 과충전, 폭풍의 일격/용암 채찍 지연, 낙뢰 없는 광역 소비, 쇄도하는 토템 위치 손실, 승천 중 바람의 일격 공백, 날카로운 바람 누락을 함께 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'paladin-protection') {
    plan.push({
      ...
      caption:
        '막대는 실제 DTPS 수치가 아니라 신성화 위치, 정의의 방패 완화, 신성한 힘 생성, 영광의 서약 복구, 천상의 종 광역 구간, 주요 생존기 분산을 한 화면에 묶은 탱커 확인용 흐름도입니다.',
      definition: [
        ...
        ['체크 포인트', '신성화 밖 탱킹, 정의의 방패 공백, 신성한 힘 과충전, 영광의 서약 과소/과다, 헌신적인 수호자와 고대 왕의 수호자 중복을 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'paladin-holy') {
    plan.push({
      ...
      sectionHeading: '신성 충격과 봉화 대상',
      sectionIntro:
        '신성 성기사는 신성 충격으로 신성한 힘과 빛 주입을 만들고, 봉화 대상으로 치유를 분배한 뒤, 단일 위험과 광역 피해에 서로 다른 소비기와 쿨다운을 배정하는 힐러입니다.',
      caption:
        '이 막대는 HPS 타임라인을 그대로 베낀 것이 아니라 신성 충격 충전, 빛 주입 소비, 빛의 봉화/구세주의 봉화 대상, 영광의 서약/영원의 불꽃 단일 회복, 여명의 빛 광역 회복, 오라 숙련과 티르의 해방 선배정을 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ['의미', '신성 충격은 신성 성기사의 중심 생성기이고, 봉화 대상은 그 치유가 실제로 도착하는 경로입니다.'],
        ['읽는 법', '피해 전에는 봉화 대상과 신성 충격 충전을 확인하고, 피해 직후 단일 위험은 영광의 서약/영원의 불꽃, 넓은 피해는 여명의 빛과 천상의 종으로 회수합니다.'],
        ['체크 포인트', '신성 충격 충전 방치, 신성한 힘 과충전, 빛 주입 소비 오류, 봉화 대상 오류, 오라 숙련 사후 사용, 티르의 해방과 응징의 격노 중복을 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'paladin-retribution') {
    plan.push({
      id: 'uptime',
      title: '사형 선고-신성한 힘 몰아넣기 타임라인',
      sectionHeading: '사형 선고와 기사단 구간',
      sectionIntro:
        '징벌 성기사는 신성한 힘을 넘치지 않게 비우면서 사형 선고 안에 응징의 격노, 파멸의 재, 빛의 망치, 천벌의 망치, 최후의 선고를 몰아넣는 근접 딜러입니다.',
      caption:
        '막대는 실제 WCL 초 단위 복사본이 아니라 사형 선고 피해 구간, 응징의 격노, 파멸의 재, 빛의 망치, 신성한 힘 생성/소비, 천상의 폭풍 광역 전환을 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ['의미', '사형 선고는 징벌의 피해 몰아넣기 기준이고, 신성한 힘은 그 구간에 강한 소모기를 넣기 위해 비워 두는 자원입니다.'],
        ['읽는 법', '큰 구간 전에는 신성한 힘을 과충전하지 않게 정리하고, 사형 선고가 열린 뒤에는 파멸의 재와 빛의 망치와 최후의 선고를 우선 넣습니다.'],
        ['체크 포인트', '사형 선고와 응징의 격노 분리, 파멸의 재 지연, 빛의 망치 누락, 전쟁의 기술 발동 방치, 단일/광역 소모기 전환 오류를 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'mage-frost') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 수치가 아니라 산산조각 중심으로 빙결 중첩 생성, 얼음창 소비, 진눈깨비 구간, 서리 광선 채널, 얼어붙은 구슬/눈보라 광역 전환을 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ...
        ['체크 포인트', '낮은 중첩 얼음창, 서리의 손가락 과충전, 두뇌 빙결 방치, 서리 광선 중 이동 손실, 얼어붙은 구슬/눈보라 대상 수 부족을 함께 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'priest-shadow') {
    plan.push({
      ...
      caption: '이 차트는 실측 로그 점수가 아니라 Wowhead/Icy Veins/KB에서 공통으로 확인한 유지, 갱신, 소비 판단을 시간축으로 바꾼 흐름도입니다.',
      definition: [
        ['의미', '지속 피해 유지는 흡혈의 손길과 어둠의 권능: 고통이 오래 사는 대상에게 끊기지 않도록 보는 체크입니다.'],
        ['읽는 법', '막대가 비는 구간은 실제 공백 시간이 아니라 다시 확인해야 하는 갱신/소모 판단 지점입니다.'],
        ['체크 포인트', '흡혈의 손길 공백, 어둠의 권능: 고통 누락, 어둠의 권능: 광기 지연, 정신 분열 충전 방치, 광역 대상 지속 피해 과투자를 함께 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'demonhunter-havoc') {
    plan.push({
      id: 'cooldown',
      title: '악마화-정수 파쇄 몰아넣기',
      sectionHeading: '악마화 구간 배정',
      sectionIntro: '파멸은 긴 쿨다운 하나보다 안광, 정수 파쇄, 죽음의 휩쓸기, 탈태 초기화를 짧은 구간에 얼마나 촘촘히 넣는지가 핵심입니다.',
      caption: '막대는 실제 로그 수치가 아니라 안광 악마화, 정수 파쇄 디버프, 죽음의 휩쓸기/파멸 소비, 탈태 초기화 순서를 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ['의미', '정수 파쇄 전에는 분노와 악마화 상태를 준비하고, 구간 안에서는 직접 강화되는 소비기만 우선합니다.'],
        ['읽는 법', '안광으로 악마화에 들어간 뒤 정수 파쇄를 쓰고, 죽음의 휩쓸기와 파멸을 먼저 넣은 다음 탈태 초기화 가치를 확인합니다.'],
        ['체크 포인트', '복수의 퇴각과 지옥칼은 피해 증폭 수단이지만, 안전한 복귀 경로가 없으면 타이밍 자체가 실패합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'demonhunter-vengeance') {
    plan.push({
      ...
      sectionIntro: '복수는 단일 딜사이클보다 다음 피해를 어떤 방어 수단으로 받고, 영혼 파편을 언제 회복/위협/방벽으로 바꿀지 보는 탱커입니다.',
      caption: '막대는 실제 로그 수치가 아니라 악마 쐐기, 불타는 낙인, 지옥 황폐, 탈태, 영혼 파편 소비를 한 전투 타임라인에 놓는 방어 확인용 흐름도입니다.',
      definition: [
        ...
        ['체크 포인트', '침묵의 인장과 불행의 인장은 딜 스킬이 아니라 던전 위험 주문을 묶는 제어 타임라인으로 따로 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'demonhunter-devourer') {
    plan.push({
      id: 'resource',
      title: '공허 탈태 상태 전환',
      sectionHeading: '공허 구간 전환',
      sectionIntro: '포식은 전투 시작부터 공허 탈태를 누르는 전문화가 아니라, 격노와 영혼 파편을 모아 공허 탈태 안팎의 우선순위를 바꾸는 전문화입니다.',
      caption: '막대는 실제 로그 수치가 아니라 흡수/영혼 제물 자원 준비, 최대 파편 수확, 공허 광선, 박멸 반응, 공허 탈태 진입, 붕괴하는 별 내부 소비를 한 화면에 묶은 상태 전환 흐름도입니다.',
      definition: [
        ...
        ['체크 포인트', '궤멸자는 공허내림-수확 루프, 공허상흔은 안전한 근접 진입과 공허쇄도 첫 발동 적중을 따로 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'deathknight-frost') {
    plan.push({
      id: 'cooldown',
      title: '얼음 기둥 몰아넣기',
      sectionHeading: '극딜 구간 배정',
      sectionIntro: '냉기는 고정 순서를 외우는 전문화가 아니라, 얼음 기둥 안에 사신의 징표, 몰살 회수, 도살기 절멸/서리낫, 숨결 유지 자원을 얼마나 촘촘하게 넣는지가 핵심입니다.',
      caption: '막대는 실제 DPS 수치가 아니라 룬 무기 강화 충전, 사신의 징표, 얼음 기둥, 숨결, 서리고룡 회수, 도살기 소비를 같은 구간에 놓는 운용 흐름도입니다.',
      definition: [
        ['의미', '얼음 기둥을 기준으로 사신의 징표와 룬 무기 강화, 도살기 소비, 신드라고사의 숨결 유지, 서리고룡 회수 시점을 함께 봅니다.'],
        ['읽는 법', '단일은 도살기 절멸, 3대상 이상은 도살기 서리낫과 빙하 진군으로 치환하고, 숨결 빌드는 룬 마력 소비보다 전방 유지 시간을 먼저 봅니다.'],
        ['체크 포인트', '룬 무기 강화 2충전 방치, 사신의 징표 대상 사망, 도살기 2중첩 손실, 서리고룡의 격노를 얼음 기둥 밖에 쓴 로그를 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'deathknight-unholy') {
    plan.push({
      id: 'resource',
      title: '하급 구울 상태 전환',
      sectionHeading: '소환수 준비',
      sectionIntro: '부정은 버튼을 일렬로 외우기보다, 악성 역병 유지와 하급 구울 스택, 부패 충전, 어둠의 변신/사자의 군대 구간이 어느 상태인지 먼저 봐야 합니다.',
      caption: '막대는 실제 DPS 수치가 아니라 질병 적용, 하급 구울 준비, 소환수 강화, 금단의 지식 소비기 전환을 한 화면에 놓는 운용 흐름도입니다.',
      definition: [
        ['의미', '돌발 열병으로 악성 역병을 깔고, 고름 일격과 부패의 낫으로 하급 구울 흐름을 준비한 뒤, 어둠의 변신과 사자의 군대 구간에서 소비합니다.'],
        ['읽는 법', '질병이 없으면 첫 단계로 돌아가고, 하급 구울 스택이 부족하면 고름 일격, 금단의 지식 중에는 괴저 고리/무덤 전환을 먼저 봅니다.'],
        ['체크 포인트', '악성 역병 누락, 어둠의 변신 전 하급 구울 부족, 영혼 수확자 처형 지연, 죽음과 부패 밖 광역 소비를 함께 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'deathknight-blood') {
    plan.push({
      ...
      sectionIntro: '혈기는 고정 딜사이클보다 다음 피해를 어떤 방어기로 받고, 그 직후 죽음의 일격을 쓸 자원이 있는지를 보는 탱커입니다.',
      caption: '막대는 실제 로그 수치가 아니라 죽음의 마수-죽음과 부패 진입, 사신의 징표/춤추는 룬 무기 순서, 죽음의 일격 회수 타이밍을 한 타임라인에 놓는 방어 확인용 흐름도입니다.',
      definition: [
        ['의미', '피해 전에는 뼈의 보호막, 위치, 생존기 배정을 보고, 피해 직후에는 죽음의 일격을 쓸 룬 마력이 남았는지 확인합니다.'],
        ['읽는 법', '죽음의 인도자는 사신의 징표를 춤추는 룬 무기 앞에 두고, 산레인은 룬 무기 안 피의 소용돌이와 흡혈의 일격으로 구간을 이어갑니다.'],
        ['체크 포인트', '죽음과 부패 위치 손실, 죽음의 일격 선소모, 룬 무기 중 빈 글쿨, 원거리 몹 정리 실패를 함께 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'druid-balance') {
    plan.push({
      id: 'uptime',
      title: '일월식 소비 구간 지도',
      sectionHeading: '일월식 구간과 영웅 특성 선택지',
      sectionIntro:
        '조화는 일월식 자체보다 일월식 초반에 어떤 소비기와 준비 버튼이 들어갔는지가 중요합니다. 레이드 숲의 수호자는 자연의 군대와 짧은 구간 맞추기를, 쐐기 엘룬의 대행자는 엘룬의 분노와 달 계열 지속 광역을 같이 봅니다.',
      caption:
        '막대는 실제 WCL 유지율이 아니라 일월식 충전, 도트 갱신, 천공의 힘, 별재봉사/우주의 손길 무료 소비기, 자연의 군대, 엘룬의 분노를 한 화면에 놓는 확인용 흐름도입니다.',
      definition: [
        ['의미', '일월식은 유지 버프가 아니라 별빛쇄도와 별똥별을 넣기 위한 짧은 피해 구간이고, 영웅 특성은 그 구간에 붙는 준비 버튼을 바꿉니다.'],
        ['읽는 법', '도트와 자연의 군대/엘룬의 분노는 일월식 전에, 별빛쇄도/별똥별/영혼 소집은 일월식 안에 들어가도록 봅니다.'],
        ['체크 포인트', '일월식 2충전 방치, 천공의 힘 과충전, 별재봉사/우주의 손길 발동 방치, 일월식 중 도트 갱신, 쐐기 풀링 위협을 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'druid-restoration') {
    plan.push({
      ...
      sectionIntro:
        '회복은 피해가 뜬 뒤 버튼을 찾는 힐러가 아니라, 피해 전에 회복 대상을 미리 만들고 상록숲 선택 시 피어나는 생명 3중첩까지 관리하는 힐러입니다.',
      caption:
        '이 차트는 HPS 예측표가 아니라 회복, 피어나는 생명, 상록숲, 꽃피우기, 급속 성장, 신속한 치유, 평온을 첫 피해 타이머에 맞춰 보는 흐름입니다.',
      definition: [
        ['의미', '피해 전 준비, 피해 순간 대응, 피해 후 복구가 한 줄로 이어져야 합니다.'],
        ['읽는 법', '회복과 피어나는 생명은 먼저 깔고, 상록숲을 찍었다면 5초마다 쌓이는 피어나는 생명 3중첩을 전제로 봅니다. 급속 성장/신속한 치유는 피해가 들어오는 순간에 맞추고, 숲 수호자는 그 시전에서 따라오는 보조 치유입니다.'],
        ['체크 포인트', '피해 후 회복 난사, 피어나는 생명 공백, 상록숲 3중첩 누락, 꽃피우기 위치 이탈, 신속한 치유 후속 주문 누락, 평온 이동 끊김을 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'druid-guardian') {
    plan.push({
      ...
      sectionIntro: '수호는 딜 스킬을 일렬로 외우는 탱커가 아니라, 첫 접촉부터 다음 피해 유형에 맞춰 위협, 무쇠가죽, 광포한 재생력, 생존기, 차단을 배정하는 전문화입니다.',
      caption: '막대는 실제 HPS나 DPS 수치가 아니라 달빛섬광 풀링, 난타 위협, 무쇠가죽 선적용, 달 광선 위치 고정, 생존기/차단 선택을 한 화면에 놓는 전투 흐름도입니다.',
      definition: [
        ['의미', '달빛섬광과 난타로 첫 위협을 잡고, 물리 피해 전에는 무쇠가죽, 마법/출혈 구간에는 나무 껍질이나 생존 본능, 피해 후에는 광포한 재생력을 배정합니다.'],
        ['읽는 법', '엘룬의 대행자는 난타/달빛섬광/삭망월로 달 광선을 빨리 돌리고, 공격 소비기는 무쇠가죽 예산이 남을 때 말살이나 후려갈기기로 전환합니다.'],
        ['체크 포인트', '첫 평타 전 무쇠가죽 공백, 달 광선 위치 손실, 두개골 강타로 끊을 수 있던 마법 피해, 공격 소비기가 방어 분노를 먹은 구간을 함께 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'druid-feral') {
    plan.push({
      id: 'uptime',
      title: '출혈 스냅샷 흐름',
      sectionHeading: '강화 출혈과 발톱 전환',
      sectionIntro: '야성은 오프닝 차트로 첫 전투 흐름을 잡고, 보조 차트에서는 갈퀴 발톱, 도려내기, 원시 분노가 어떤 강화 상태로 유지되는지와 쐐기 발톱의 드루이드 직접 피해 전환이 어디에 얹히는지를 봅니다.',
      caption: '막대는 실제 로그 유지율 퍼센트가 아니라 호랑이의 분노 스냅샷, 팬데믹 갱신, 원시 분노 광역 갱신, 물어뜯기/찢어발기기 전환, 흉포한 이빨 소비 조건을 한 화면에 놓는 확인용 흐름도입니다.',
      definition: [
        ['의미', '레이드 야생추적자는 갈퀴 발톱과 도려내기 강화 상태를, 쐐기 발톱의 드루이드는 출혈 기반 위에 직접 피해 구간을 얹는지를 확인합니다.'],
        ['읽는 법', '출혈 막대가 갱신 구간에 들어오면 연계 점수와 호랑이의 분노 대기시간을 보고, 쐐기에서는 원시 분노 뒤 물어뜯기와 찢어발기기 전환을 확인합니다.'],
        ['체크 포인트', '도려내기 공백, 원시 분노 지연, 호랑이의 분노 기력 과잉, 광폭화 중 연계 점수 과충전, 첫 풀 탱커 위협을 함께 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'hunter-beastmastery') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 수치가 아니라 야수의 격노 구간, 날카로운 사격 충전 정리, 자연의 동맹 살상 명령, 마구잡이 난타/야수의 회전베기, 어둠 순찰자 선택지를 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ['의미', '야수의 격노는 중심 구간이고, 날카로운 사격과 살상 명령은 그 안에 들어갈 살상 명령 횟수를 만드는 입력입니다.'],
        ['읽는 법', '다중 대상에서는 야수의 회전베기 흐름이 켜진 뒤 야수의 격노가 들어가는지 보고, 어둠 순찰자는 부패의 사격과 울부짖는 화살을 별도 선택지로 봅니다.'],
        ['체크 포인트', '야수의 격노 사용 횟수, 날카로운 사격 2충전 방치, 살상 명령 두 번 연속 입력, 광역 야수의 회전베기 공백을 함께 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'hunter-marksmanship') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 수치가 아니라 조준 사격 충전 관리, 속사/총알 세례 준비, 정밀 사격 소비, 교묘한 사격 광역 조건, 정조준 구간, 파수꾼/어둠 순찰자 후속 버튼을 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ['의미', '조준 사격은 중심 노드이고, 정밀 사격과 속사는 다음 조준 사격의 위치와 타이밍을 정하는 입력입니다.'],
        ['읽는 법', '단일은 신비한 사격으로 정밀 사격을 소비하고, 광역은 일제 사격으로 교묘한 사격을 켠 뒤 조준 사격과 속사를 넣는지 봅니다.'],
        ['체크 포인트', '조준 사격 2충전 방치, 속사 지연, 정밀 사격 과소비/미소비, 정조준 전 총알 세례 준비, 영웅 특성 후속 버튼 배치를 함께 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'hunter-survival') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 수치가 아니라 살상 명령 충전, 창끝 중첩, 제압 타이밍, 야생불 폭탄 충전, 붐스틱 전방 각도, 랩터의 휩쓸기 광역 조건, 무리의 지도자/파수꾼 선택지를 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ['의미', '창끝은 생존의 중심 버프이며, 살상 명령은 창끝과 집중을 만드는 생성기입니다.'],
        ['읽는 법', '제압 전에 창끝과 폭탄/붐스틱 준비를 확인하고, 광역에서는 전방 부채꼴 기술이 실제 대상에게 맞는지 봅니다.'],
        ['체크 포인트', '살상 명령 충전 낭비, 창끝 3중첩 방치, 제압 전 준비 부족, 야생불 폭탄 2충전, 붐스틱/랩터의 휩쓸기 방향 손실을 함께 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'mage-fire') {
    plan.push({
      ...
      sectionIntro:
        '화염은 발화, 열기, 화염 작렬 충전, 몰아치는 열기!, 불덩이 작렬/불기둥 소비가 같은 구간 안에서 끊기지 않는지를 시간축으로 봐야 합니다.',
      caption:
        '막대는 실제 WCL 수치가 아니라 발화 구간, 유성 착탄, 화염 작렬 충전, 몰아치는 열기! 소비, 불기둥 광역 전환, 생존기 보존을 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ['의미', '발화는 화염의 중심 구간이고, 몰아치는 열기!는 그 안에서 불덩이 작렬 또는 불기둥으로 바로 소비해야 하는 상태입니다.'],
        ['읽는 법', '발화 전에 화염 작렬 충전과 유성 착탄을 준비하고, 발화 안에서는 열기를 몰아치는 열기!로 바꾼 뒤 소비기를 끊지 않습니다.'],
        ['체크 포인트', '발화 지연, 유성 착탄 이탈, 화염 작렬 과충전, 몰아치는 열기! 방치, 불기둥 대상 수 부족, 이동으로 인한 발화 구간 손실을 함께 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'mage-arcane') {
    plan.push({
      ...
      sectionHeading: '비전 연사와 큰 구간 흐름',
      sectionIntro:
        '비전은 비전 쇄도, 비전의 여파, 비전 연사, 비전 탄막, 비전 보주가 같은 구간을 가리키는지를 시간축으로 봐야 합니다.',
      caption:
        '막대는 실제 WCL 수치가 아니라 비전 연사 예열, 비전 쇄도 90초 구간, 비전의 여파 45초 구간, 비전 보주 재충전, 비전 탄막 소비, 환기 복구를 한 화면에 묶은 확인용 흐름도입니다.',
      definition: [
        ['의미', '비전 연사는 비전 탄막 소비 타이밍을 정하는 중심 자원이고, 비전 쇄도와 비전의 여파는 그 소비를 넣을 시간표입니다.'],
        ['읽는 법', '큰 구간 전에는 비전 연사와 마나를 준비하고, 구간 안에서는 비전 보주와 신비한 화살 발동을 소비한 뒤 비전 탄막으로 정리합니다.'],
        ['체크 포인트', '비전 쇄도 지연, 비전의 여파 45초 간격 붕괴, 낮은 비전 연사 탄막, 마나 부족 탄막 과다, 비전 보주 4충전 낭비를 함께 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'evoker-devastation') {
    plan.push({
      id: 'resource',
      title: '용의 분노-정수 소비 구간',
      sectionHeading: '용의 분노와 정수 관리',
      sectionIntro:
        '황폐는 쿨다운을 누르는 순서보다 용의 분노 구간 안에 강화 주문, 정수 폭발, 파열/기염, 하늘빛 휩쓸기를 얼마나 손실 없이 넣는지가 핵심입니다.',
      caption:
        '막대는 실제 DPS 수치가 아니라 용의 분노, 불의 숨결, 영원의 쇄도, 정수 폭발, 파열/기염, 하늘빛 휩쓸기를 한 화면에 놓는 확인용 흐름도입니다.',
      definition: [
        ['의미', '용의 분노는 2분 쿨다운 자체보다 그 안에 들어가는 강화 주문과 정수 소비 횟수로 평가합니다.'],
        ['읽는 법', '불의 숨결과 영원의 쇄도는 구간을 열고, 산산이 부서지는 별 뒤에는 정수 폭발과 파열/기염을 밀어 넣습니다.'],
        ['체크 포인트', '정수 과충전, 정수 폭발 2중첩 방치, 하늘빛 휩쓸기 충전 방치, 부양 없는 이동 손실을 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'priest-discipline') {
    plan.push({
      ...
      sectionIntro:
        '수양은 힐 버튼을 많이 누르는 전문화가 아니라, 피해 전에 속죄와 보호막을 깔고 피해 직후 회개/정신 분열로 회수하는 전문화입니다. 이 차트는 속죄 준비, 피해 전 보호막, 피해 후 회수, 외생기 분배가 서로 다른 판단이라는 것을 보여줍니다.',
      caption: '수양은 고정 순서보다 피해가 들어오기 전 몇 초에 속죄를 깔고 어떤 쿨다운을 남길지 보는 타임라인이 중요합니다.',
      definition: [
        ['의미', '막대는 실제 로그 수치가 아니라 피해 예고, 속죄 준비, 사도/광휘 구간, 외생기 분배를 한 화면에 놓기 위한 확인용 흐름도입니다.'],
        ['읽는 법', '피해 전에는 속죄 수와 신의 권능: 광휘 충전을 보고, 피해 직후에는 회개와 정신 분열이 속죄가 남아 있는 동안 들어갔는지 확인합니다.'],
        ['체크 포인트', '고통 억제, 신의 권능: 방벽, 궁극의 참회, 보호막 분배가 같은 피해에 겹치지 않도록 구간을 나누는 것이 목표입니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'priest-holy') {
    plan.push({
      ...
      definition: [
        ['의미', '막대는 실제 로그 수치가 아니라 빛의 권능 충전, 빛의 쇄도 순간 치유 소비, 빛술사 이후 치유의 기원 소비, 절정 몰아넣기, 후광 위치, 천상의 찬가 채널, 수호 영혼 배정을 한 화면에 놓는 흐름도입니다.'],
        ['읽는 법', '빛의 권능이 두 충전에 가까우면 먼저 비우고, 다음 피해가 짧으면 절정/후광, 길고 넓으면 천상의 찬가를 우선 검토합니다.'],
        ['체크 포인트', '회복의 기원은 전투 내내 굴리고, 빛의 쇄도는 순간 치유로 소비했는지, 빛술사 없이 치유의 기원을 남발해 마나를 망가뜨리지 않았는지 함께 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'evoker-preservation') {
    plan.push({
      ...
      caption:
        '막대는 실제 HPS 수치가 아니라 메아리, 시간 변칙, 메리스라의 축복, 되감기, 정지장, 되돌리기, 꿈의 비행을 피해 타이머에 놓는 확인용 흐름도입니다.',
      definition: [
        ...
        ['체크 포인트', '에메랄드 꽃은 메아리 소비기가 아니며, 되감기와 되돌리기는 각각 지속 회복과 피해 후 복구로 분리해 확인합니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'evoker-augmentation') {
    plan.push({
      ...
      sectionHeading: '지원 버프 유지와 파티 극딜 타이밍',
      sectionIntro:
        '증강은 개인 딜사이클보다 칠흑의 힘 유지, 예지 대상, 영겁의 숨결 파티 극딜 타이밍, 분출 소비가 서로 맞물리는지가 중요합니다.',
      caption:
        '막대는 실제 WCL 수치가 아니라 칠흑의 힘, 예지, 영겁의 숨결, 분출/강화 주문, 탱커 지원을 한 화면에 놓는 지원 확인용 흐름도입니다.',
      definition: [
        ['의미', '증강의 핵심 데이터는 개인 DPS가 아니라 버프가 누구에게, 언제, 얼마나 유지됐는지입니다.'],
        ['읽는 법', '칠흑의 힘은 전투 전반의 중심 흐름, 예지는 대상 선정 흐름, 영겁의 숨결은 파티 극딜 흐름으로 따로 봅니다.'],
        ['체크 포인트', '칠흑의 힘 공백, 잘못된 예지 대상, 영겁의 숨결 장거리 비행, 버프 밖 분출 소비를 확인합니다.'],
      ],
    });
    return plan;
  }
