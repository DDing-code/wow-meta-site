...
const SPECIALIST_CHARTS = {
  'monk-brewmaster': {
    id: 'defensive',
    title: '양조 피해별 방어 선택',
    sectionHeading: '정화·흡수·회복을 나눠 쓰기',
    sectionIntro: '현재 생명력, 남은 시간차, 다음 타격과 충전 수를 함께 봅니다. 아래는 고정 순서가 아니라 상황별 선택이며, 급한 방어를 공격 우선순위 뒤까지 기다리지 않습니다.',
    caption: '실제 피해 조건에 맞춰 선택합니다. 천신주와 천신의 주입은 같은 선택 칸이므로 둘 중 선택한 기술만 사용합니다.',
    definition: [
      [
        '남은 피해',
        '정화주는 누적 시간차를 줄이고 흡수기는 직접 타격과 남은 시간차 틱을 받아냅니다. 피해 전·후로 사용을 금지하지 않습니다.'
      ],
      [
        '충전 관리',
        '정화주가 가득 차면 초록 시간차도 사용 후보입니다. 다음 타격에 필요한 몫과 전투 중 재사용 감소를 함께 확인합니다.'
      ],
      [
        '회복과 제어',
        '구슬 빌드에 따른 치유 대응, 큰 피해 감소, 적의 자동 공격과 특별 공격을 나눠 봅니다. 여러 버튼을 무조건 동시에 쓰지 않습니다.'
      ]
    ],
    events: [
      {
        phase: '큰 타격 직후·시간차 급증',
        skillId: '119582',
        action: '남은 시간차 정화',
        note: '현재 누적 피해를 줄입니다. 강한 내성의 고조된 시간차 환급과 다음 타격에 남길 충전을 함께 보며 빨간 색상만으로 판단하지 않습니다.'
      },
      {
        phase: '정화주 충전 가득·다음 회복 여유',
        skillId: '119582',
        action: '충전 손실 방지',
        note: '초록 시간차라도 회복이 멈추는 손실을 줄일 수 있습니다. 곧 필요한 연속 정화 몫을 모두 소모하지 않습니다.'
      },
      {
        phase: '짧은 큰 타격·남은 시간차 틱',
        skillId: '322507',
        action: '8초 흡수',
        note: '천신주를 선택했을 때 사용합니다. 큰 직접 피해와 현재 시간차 틱을 총 흡수 한도까지 막으며 이미 맞았다는 이유로 무효가 아닙니다.'
      },
      {
        phase: '지속 피해·흡수기 선택',
        skillId: '1241059',
        action: '16초 분할 흡수',
        note: '천신의 주입 선택 시 천신주 대신 사용합니다. 피해의 30%씩을 한도까지 흡수하며 한도가 끝나면 16초 동안 계속 보장되지 않습니다.'
      },
      {
        phase: '생명력 급락·기본 구슬 보유',
        skillId: '322101',
        action: '구슬 회수 치유',
        note: '니우짜오의 결의 미선택 기본 구슬 빌드에서 구슬을 모아 회복합니다. 지속 치유 빌드와 같은 버튼 사용 횟수를 강요하지 않습니다.'
      },
      {
        phase: '큰 공격이 예고된 구간',
        skillId: '115203',
        action: '생명력·피해 감소',
        note: '강화주의 선택 효과로 다음 타격을 버팁니다. 흡수기와 무조건 동시에 묶기보다 이어지는 타격에 분산할 수 있는지 확인합니다.'
      },
      {
        phase: '25초 탱킹 압박·소환 활용 가능',
        skillId: '132578',
        action: '시간차 분담',
        note: '니우짜오가 시간차 일부를 대신 받습니다. 소환 중에도 후려차기와 정화주를 활용하고 원령에게 들어간 치유를 자기 치유에 합산하지 않습니다.'
      },
      {
        phase: '여러 적의 근접 자동 공격 집중',
        skillId: '325153',
        action: '평타 피해 완화',
        note: '선택한 폭발하는 맥주통을 사용합니다. 보스 특수 공격·마법 주문까지 무효화하지 않으며 맥주통 초기화와 후속 강화를 따로 회수합니다.'
      }
    ]
  },
  'monk-mistweaver': {
  ...
  'warrior-arms': {
    ...
    caption: '필사의 일격 주기, 거인의 강타/투신, 제압 충전, 마무리 일격, 칼날폭풍 또는 쇄파를 같은 구간에서 확인합니다.',
    definition: [
  ...
  'shaman-restoration': {
    ...
    sectionIntro: '복원 주술사는 성난 해일 대상과 치유의 비/쇄도하는 토템 위치를 먼저 잡고 피해를 받습니다. 연쇄 치유와 치유의 물결로 대상 수에 맞춰 회수하고, 폭우는 특성을 찍은 경우에만 더합니다. 정신의 고리 토템과 선택한 치유의 해일 토템 또는 승천은 큰 피해에 배정합니다.',
    caption: '성난 해일 대상, 지역 치유 위치, 치유의 토템 충전, 연쇄 치유를 확인합니다. 폭우 행은 특성을 선택한 빌드에만 해당합니다. 치유의 해일 토템과 승천은 같은 선택 노드이므로 아래 두 행은 한 빌드의 연속 사용이 아닌 대안입니다.',
    definition: [
      ['의미', '기본 흐름은 성난 해일 대상과 지역 치유 위치를 준비하고, 다친 대상 수에 맞춰 직접 치유를 선택하는 것입니다. 폭우는 선택형 광역 회복입니다.'],
      ['읽는 법', '피해 전 성난 해일 대상과 지역 치유 위치를 준비하고, 연쇄 치유/치유의 물결/폭풍의 흐름 토템으로 회수합니다. 폭우를 찍었다면 추가 행을 보고, 큰 피해에는 정신의 고리 토템과 선택한 치유의 해일 토템 또는 승천을 배정합니다.'],
      ['체크 포인트', '성난 해일 대상 부족, 치유의 비 위치 손실, 마나 과소비, 폭풍의 흐름 토템 충전 낭비, 큰 쿨기 중복을 봅니다. 폭우 빌드에서는 사용권과 실제 피해의 겹침도 봅니다.'],
    ],
  },
  'shaman-enhancement': {
    id: 'resource',
  ...
  'paladin-protection': {
    id: 'defensive',
    title: '보호 피해별 방어 선택',
    sectionHeading: '방패·회복·면역을 나눠 쓰기',
    sectionIntro: '현재 방어 시간과 다음 타격의 종류를 함께 봅니다. 아래는 고정 순서가 아니라 상황별 선택이며, 급한 생존과 차단을 공격 순위 뒤까지 기다리지 않습니다.',
    caption: '기본 방어는 계속 유지하고, 큰 생존기는 실제 위험 구간별로 배정합니다. 참을성·공유 대기시간·마지막 저항 선택 여부도 확인합니다.',
    definition: [
      [
        '기본 방어',
        '정의의 방패는 물리 방어도와 선택한 마법 감소, 성역은 발밑 위치의 피해 감소입니다. 한 효과가 다른 효과의 공백을 지워 주지는 않습니다.'
      ],
      [
        '큰 피해',
        '12초의 헌신적인 수호자와 8초의 고대 왕의 수호자를 다음 공격 순서에 맞춰 나눕니다. 파수꾼은 현재 중첩도 봅니다.'
      ],
      [
        '회복·면역',
        '무료 영광의 서약도 글쿨·마나를 쓰며 물리 면역과 마법 면역은 다른 선택입니다. 면역이 적용되지 않는 기믹도 확인합니다.'
      ]
    ],
    events: [
      {
        phase: '근접 공격·기본 방어 공백',
        skillId: '53600',
        action: '먼저 방패 유지',
        note: '신성한 힘 3개가 있으면 사용합니다. 거룩한 도구의 최대 피해를 기다리느라 첫 타격을 방어 없이 맞지 않습니다.'
      },
      {
        phase: '이동 종료·발밑 바닥 없음',
        skillId: '26573',
        action: '새 위치에 신성화',
        note: '성역의 짧은 유예 안에 안전한 위치를 잡습니다. 본인과 적을 같이 바닥에 두어 피해·회복·세트 효과를 활용합니다.'
      },
      {
        phase: '연속 큰 타격·죽음 방지 필요',
        skillId: '31850',
        action: '12초 피해 감소',
        note: '현재 30% 감소와 한 번의 죽음 방지를 활용합니다. 연마 선택으로 효과가 남아도 죽음 방지를 무제한 다시 받는 것은 아닙니다.'
      },
      {
        phase: '매우 큰 피해·짧은 집중 공격',
        skillId: '86659',
        action: '8초 강한 방어',
        note: '50% 피해 감소를 타격 전에 배정합니다. 추가 충전과 황금 발키르 자동 발동을 직접 시전과 나누어 관리합니다.'
      },
      {
        phase: '방패 유지 중·치유 또는 사전 흡수',
        skillId: '85673',
        action: '무료 치유 회수',
        note: '눈부신 빛과 필요한 생명력을 봅니다. 축복받은 서약을 고른 경우 초과 치유 흡수를 활용하지만 유료 소비로 기본 방어를 끊지 않습니다.'
      },
      {
        phase: '면역 가능한 마법 공격',
        skillId: '204018',
        action: '마법 면역 배정',
        note: '보호의 축복과 대기시간을 공유하며 참을성을 남깁니다. 물리 공격이나 면역 불가 기믹을 같은 방식으로 막을 수는 없습니다.'
      },
      {
        phase: '면역 가능한 물리 피해·아군 구조',
        skillId: '1022',
        action: '물리 면역 선택',
        note: '마법 면역과 구분하고 탱커 대상 선택 변화에 주의합니다. 바로 뒤 신의 축복이 필요하면 참을성 충돌도 확인합니다.'
      },
      {
        phase: '주위 15야드 적·마지막 저항 선택',
        skillId: '642',
        action: '면역과 범위 도발',
        note: '선택 특성이 있어야 해당 도발 운용이 가능합니다. 먼 적·도발 면역 대상은 자동으로 해결되지 않으므로 위치와 인계를 확인합니다.'
      },
      {
        phase: '차단 가능한 위험 주문',
        skillId: '96231',
        action: '피해 전에 차단',
        note: '주문을 막아 후속 피해를 없앱니다. 원거리 응징의 방패와 기절 가능한 적의 심판의 망치는 별도의 제어 수단입니다.'
      }
    ]
  },
  'paladin-holy': {
  ...
  'druid-balance': {
    id: 'resource',
    title: '12.1 일월식과 천공의 힘',
    sectionHeading: '일월식 준비와 구간 양끝 소비',
    sectionIntro: '현재 기본인 엘룬의 대행자는 별빛섬광으로 천공의 힘을 모으고, 도트와 엘룬의 분노를 먼저 정리한 뒤 일월식 시작과 끝에 별빛쇄도·별똥별을 배치합니다.',
    caption: '달빛섬광·태양섬광, 엘룬의 분노, 일월식 (달), 아킬존의 명료함과 단일·광역 소비를 확인합니다.',
    definition: [
      ['의미', '일월식은 2회 충전되는 피해 쿨기이고, 아킬존의 명료함은 구간 시작과 끝을 더 강하게 만듭니다.'],
      ['읽는 법', '일월식 전에 도트와 천공의 힘을 준비하고, 단일은 별빛쇄도, 오래 사는 3대상 이상은 별똥별로 소비합니다. 정확히 2대상은 특성과 우선 대상 피해를 함께 봅니다.'],
      ['체크 포인트', '일월식 2충전, 진입 자원 부족, 구간 안 도트 갱신, 천공의 힘 과충전, 항성 증폭 대상 전환을 봅니다.'],
    ],
  },
  'druid-restoration': {
    id: 'uptime',
  ...
  'druid-guardian': {
    id: 'defensive',
    title: '12.1 피해별 방어 판단',
    sectionHeading: '지금 필요한 방어와 회복',
    sectionIntro: '평타를 줄이는 무쇠가죽, 강타 전에 쓰는 피해 감소, 재생력의 회복과 선택 특성 보호막은 역할이 다릅니다. 아래 항목은 전부 순서대로 누르는 콤보가 아니라 실제 피해에 따라 고르는 대응입니다.',
    caption: '자원이 없는 진입, 물리 피해, 큰 강타, 조건부 재생력 선사용과 곰 상태 회복을 구분합니다. 실제 로그의 시간이나 유지율을 나타내는 차트가 아닙니다.',
    definition: [
      ['기준', '생존에 필요한 대응은 공격 우선순위보다 먼저입니다. 현재 분노와 실제 피해 유형을 함께 봅니다.'],
      ['회복 조건', '자연의 탄력은 초과 치유 보호막, 샘솟는 힘은 최대 생명력을 줍니다. 선택했다면 광포한 재생력 선사용도 가능합니다.'],
      ['주의', '무쇠가죽 중첩은 개별적으로 끝납니다. 재생력은 한 방에 죽는 피해를 먼저 줄여 주는 생존기의 대체물이 아닙니다.'],
    ],
    events: [
      { phase: '진입 직전', skillId: '22812', label: '나무 껍질', note: '첫 방어 분노가 부족한 위험 진입을 덮고 생성기를 사용합니다.', action: '접촉 전에 준비' },
      { phase: '평타·물리 강타', skillId: '192081', label: '무쇠가죽', note: '맞기 전에 필요한 중첩을 확보합니다. 기존 중첩의 종료 시간은 새 사용으로 모두 갱신되지 않습니다.', action: '분노와 남은 시간 확인' },
      { phase: '치명적인 피해 전', skillId: '61336', label: '생존 본능', note: '큰 마법·물리 피해를 먼저 줄입니다. 필요한 경우 외부 생존기와 배정하며 습관적으로 모든 쿨기를 겹치지 않습니다.', action: '강타 전에 사용' },
      { phase: '예측 피해 직전', skillId: '22842', label: '광포한 재생력 선사용', note: '자연의 탄력·샘솟는 힘 선택 시 보호막이나 최대 생명력 준비가 가능합니다. 선택하지 않았다면 같은 이득을 기대하지 않습니다.', action: '특성 조건 확인' },
      { phase: '체력 하락', skillId: '22842', label: '광포한 재생력 복구', note: '남은 충전으로 실제 피해를 회복합니다. 최대 보정을 기다리다가 다음 평타에 죽지 않습니다.', action: '첫 회복 전에 버틸지 확인' },
...
function getUptimeRows(guide, data) {
    ...
    return [
      {
        ...
        note: '성난 해일 대상, 굽이치는 물결, 연쇄 치유 첫 대상을 묶습니다. 선조 발동은 선견자의 일상적인 교감 선택 시에만 가능합니다.',
      ...
      },
      {
        ...
        note: '폭우 특성을 찍은 경우에만 해당합니다. 추가 치유의 비 위치와 실제 피해가 겹칠 때 회수합니다.',
      ...
      },
      {
        ...
        note: '승천과 양자택일입니다. 선택했다면 긴 광역 피해에 배정합니다.',
      ...
      },
      {
        ...
        note: '치유의 해일 토템과 양자택일입니다. 선택했다면 직접 치유를 많이 넣을 수 있는 구간에 맞춥니다.',
        segments: [[56, 18]],
      },
      {
        label: '선견자 구간',
  ...
  if (guide.id === 'warrior-arms') {
    return [
      ...
      {
        label: '피해 구간',
        skill: findSkillByNames(data, ['거인의 강타']),
  ...
  if (guide.id === 'druid-balance') {
    return [
      ...
      },
      {
        ...
        note: '2충전을 방치하지 않고, 진입 전에 최소 두 소비기분의 천공의 힘을 준비합니다.',
      ...
      },
      {
        ...
        note: '짧은 광역 대안에서는 자연의 군대 직후 일월식 또는 화신을 여는지 봅니다.',
        segments: [[16, 13], [64, 13]],
      },
      {
        label: '엘룬의 대행자 구간',
        skill: findSkillByNames(data, ['엘룬의 분노']),
        note: '12.1 기본 빌드는 엘룬의 분노 뒤 일월식 (달)과 별빛섬광 시전 유지를 같이 봅니다.',
