...
function getInlineChartPlan(guide, data) {
  ...
  if (guide.id === 'paladin-protection') {
    plan.push({
      ...
      caption:
        '막대는 실제 DTPS 수치가 아니라 신성화 위치, 정의의 방패 완화, 신성한 힘 생성, 영광의 서약 복구, 천상의 종 광역 구간, 주요 생존기 분산을 한 화면에 묶은 탱커 판단 도식입니다.',
      definition: [
  ...
  if (guide.id === 'paladin-holy') {
    plan.push({
      ...
      caption:
        '막대는 실제 HPS 복사본이 아니라 신성 충격 충전, 빛 주입 소비, 빛의 봉화/구세주의 봉화 대상망, 영광의 서약/영원의 불꽃 단일 회복, 여명의 빛 광역 회복, 오라 숙련과 티르의 해방 선배정을 한 화면에 묶은 판단 도식입니다.',
      definition: [
  ...
  if (guide.id === 'paladin-retribution') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 초 단위 복사본이 아니라 사형 선고 피해 구간, 응징의 격노, 파멸의 재, 빛의 망치, 신성한 힘 생성/소비, 천상의 폭풍 광역 전환을 한 화면에 묶은 판단 도식입니다.',
      definition: [
  ...
  if (guide.id === 'mage-frost') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 수치가 아니라 산산조각 중심으로 빙결 중첩 생성, 얼음창 소비, 진눈깨비 구간, 서리 광선 채널, 얼어붙은 구슬/눈보라 광역 전환을 한 화면에 묶은 판단 도식입니다.',
      definition: [
  ...
  if (guide.id === 'demonhunter-vengeance') {
    plan.push({
      ...
      definition: [
        ...
        ['체크 포인트', '침묵의 인장과 불행의 인장은 딜 버튼이 아니라 던전 위험 주문을 묶는 제어 타임라인으로 따로 봅니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'deathknight-frost') {
    plan.push({
      ...
      caption: '막대는 실제 DPS 수치가 아니라 룬 무기 강화 충전, 사신의 징표, 얼음 기둥, 숨결, 서리고룡 회수, 도살기 소비를 같은 구간에 놓는 운용 도식입니다.',
      definition: [
  ...
  if (guide.id === 'hunter-beastmastery') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 수치가 아니라 야수의 격노 구간, 날카로운 사격 충전 정리, 자연의 동맹 살상 명령, 마구잡이 난타/야수의 회전베기, 어둠 순찰자 선택지를 한 화면에 묶은 판단 도식입니다.',
      definition: [
        ['의미', '야수의 격노는 중심 구간이고, 날카로운 사격과 살상 명령은 그 안의 밀도를 만드는 입력입니다.'],
  ...
  if (guide.id === 'hunter-marksmanship') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 수치가 아니라 조준 사격 충전 관리, 속사/총알 세례 준비, 정밀 사격 소비, 교묘한 사격 광역 조건, 정조준 구간, 파수꾼/어둠 순찰자 후속 버튼을 한 화면에 묶은 판단 도식입니다.',
      definition: [
  ...
  if (guide.id === 'hunter-survival') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 수치가 아니라 살상 명령 충전, 창끝 중첩, 제압 타이밍, 야생불 폭탄 충전, 붐스틱 전방 각도, 랩터의 휩쓸기 광역 조건, 무리의 지도자/파수꾼 선택지를 한 화면에 묶은 판단 도식입니다.',
      definition: [
  ...
  if (guide.id === 'mage-fire') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 수치가 아니라 발화 구간, 유성 착탄, 화염 작렬 충전, 몰아치는 열기! 소비, 불기둥 광역 전환, 생존기 보존을 한 화면에 묶은 판단 도식입니다.',
      definition: [
  ...
  if (guide.id === 'mage-arcane') {
    plan.push({
      ...
      caption:
        '막대는 실제 WCL 수치가 아니라 비전 연사 예열, 비전 쇄도 90초 구간, 비전의 여파 45초 구간, 비전 보주 재충전, 비전 탄막 소비, 환기 복구를 한 화면에 묶은 판단 도식입니다.',
      definition: [
  ...
  if (guide.id === 'priest-discipline') {
    plan.push({
      ...
      definition: [
        ['의미', '막대는 실제 로그 수치가 아니라 피해 예고, 속죄 준비, 사도/광휘 구간, 외생기 분배를 한 화면에 놓기 위한 판단 도식입니다.'],
  ...
  if (guide.id === 'priest-holy') {
    plan.push({
      ...
      definition: [
        ['의미', '막대는 실제 로그 수치가 아니라 빛의 권능 충전, 빛의 쇄도 순간 치유 소비, 빛술사 이후 치유의 기원 소비, 절정 몰아넣기, 후광 위치, 천상의 찬가 채널, 수호 영혼 배정을 한 화면에 놓는 도식입니다.'],
  ...
  if (guide.id === 'shaman-enhancement') {
    return [
      ...
      },
      {
        ...
        note: '질풍의 무기와 근접 타격 밀도가 중요한 1분 구간입니다.',
        segments: [[6, 14], [57, 14]],
      },
      {
        label: '승천 구간',
  ...
  if (guide.id === 'rogue-outlaw') {
    return [
      ...
      },
      {
        ...
        note: '재사용 대기시간 손실을 막아야 하는 고가치 마무리 기술입니다.',
  ...
  if (guide.id === 'warlock-destruction') {
    return [
      ...
      },
      {
        ...
        note: '조각 생성과 소모 밀도를 동시에 여는 구간입니다.',
  ...
  if (guide.id === 'hunter-beastmastery') {
    return [
      ...
      },
      {
        ...
        note: '구간 안 살상 명령, 세트 효과, 영웅 특성 발동 밀도를 봅니다.',
