...
function getInlineChartPlan(guide, data) {
  ...
  if (guide.id === 'rogue-outlaw') {
    plan.push({
      ...
      sectionIntro:
        '무법 도적은 생성기와 마무리 기술의 단순 반복이 아니라, 마무리 기술이 잠들지 않는 칼날을 통해 다음 아드레날린 촉진, 미간 적중, 폭풍의 칼날, 질풍 칼날, 광기의 학살자, 뼈주사위 창을 앞당기는 구조입니다. 이 타임라인은 연계 점수 생성, 5~6점 소비, 뼈주사위 단계, 폭풍의 칼날 전환, 기만자와 운명결속 보정이 한 전투 안에서 어떻게 맞물리는지 보여줍니다.',
      caption:
        '막대는 실제 WCL 초 단위 복사본이 아니라 로그를 검수하는 순서입니다. 먼저 마무리 기술 빈도와 연계 점수 과충전을 보고, 그 다음 미간 적중 지연, 아드레날린 촉진과 준비 되감기, 폭풍의 칼날 다중 대상 적중, 무형검/최후의 일격 또는 운명의 손/행운 주화 분기를 확인합니다.',
      definition: [
        ...
        ['검수 포인트', '연계 점수 과충전, 기회 6중첩 방치, 미간 적중 지연, 준비 조기 사용, 폭풍의 칼날 없는 다중 대상, 최후의 일격 속결 지연, 행운 주화 중 마무리 기술 손실을 함께 잡습니다.'],
      ],
    });
    return plan;
  }
  ...
  if (guide.id === 'rogue-subtlety') {
    plan.push({
      ...
      definition: [
        ['의미', '은밀한 기술은 잠행 그래프의 중앙 마무리 기술이고, 어둠의 춤은 그 버튼을 넣는 짧은 창입니다.'],
    ...
    return [
      {
        ...
        note: '5~6점 마무리 기술이 다음 쿨기 창을 앞당기는 무법의 중심 피드백입니다.',
