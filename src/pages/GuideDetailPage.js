...
const SPECIALIST_CHARTS = {
  ...
  'shaman-restoration': {
    ...
    sectionIntro: '복원 주술사는 성난 해일 대상과 치유의 비/쇄도하는 토템 위치를 먼저 잡고, 마나를 과하게 태우지 않는 예열로 피해 파도를 받습니다. 폭우와 연쇄 치유로 짧은 피해를 회수하고, 정신의 고리 토템과 선택한 치유의 해일 토템 또는 승천을 큰 피해에 배정합니다.',
    caption: '성난 해일 대상, 지역 치유 위치, 치유의 토템 충전, 폭우, 연쇄 치유를 확인합니다. 치유의 해일 토템과 승천은 같은 선택 노드이므로 아래 두 행은 한 빌드의 연속 사용이 아닌 대안입니다.',
    definition: [
      ['의미', '폭우는 구버전 저장형 버튼이 아니라 치유의 비나 쇄도하는 토템 위치 위에서 예고 피해를 낮은 비용으로 회복하는 짧은 광역 구간입니다.'],
      ['읽는 법', '피해 전 성난 해일 대상과 지역 치유 위치를 준비하고, 폭우/연쇄 치유/폭풍의 흐름 토템으로 회수합니다. 큰 피해에는 정신의 고리 토템과 특성에서 선택한 치유의 해일 토템 또는 승천을 배정합니다.'],
