...
const unifiedTheme = {
  colors: {
    primary: '#3FC6EA',      // 마법사 색상
    secondary: '#1a1a2e',
    background: '#0a0a0f',
    surface: '#15151f',
    text: '#e0e0e0',
    subtext: '#a0a0a0',
    accent: '#3FC6EA',       // 마법사 색상
    border: '#2a2a3e',
    hover: 'rgba(63, 198, 234, 0.1)',  // 마법사 색상 (RGB)
    success: '#4caf50',
    danger: '#f44336',
    warning: '#ff9800',
  },
...
const getHeroContent = (SkillIcon) => ({
  sunfury: {
    ...
    icon: '🔥',
    tierSet: {
      '2set': '2세트: 주문불꽃 구체가 입히는 피해가 20% 증가합니다.',
      '4set': '4세트: 불사조가 6초 동안 비전 영혼을 남깁니다. 비전 영혼은 비전 피해를 입힙니다.'
    },
    singleTarget: {
      opener: [
        skillData.evocation,        // 4초 사전시전
        skillData.arcaneMissiles,   // 1초 사전시전
        skillData.touchOfTheMagi,   // 마법사의 손길
        skillData.arcaneSurge,      // 비전 쇄도
        skillData.arcaneBlast,      // 비전 작렬 (4충전까지)
        skillData.arcaneOrb,        // 비전 보주
        skillData.arcaneBarrage     // 비전 탄막
      ],
      priority: [
        {
          skill: skillData.arcaneMissiles,
          desc: '명석함 3중첩 시 비전 미사일',
          conditions: [
            '명석함 3중첩 보유',
            '비전 충전 4중첩 보유',
            '명석함 버프 만료 전 사용'
          ],
          why: '명석함 3중첩 + 비전 충전 4중첩 시 최대 피해 - 최우선'
        },
        {
        ...
        },
        {
          ...
          conditions: [
            '비전 충전 4중첩',
            '직관 OR 글로리어스 인칸데슨스 버프 활성',
            '주문불꽃 구체 생성'
          ],
          why: '버프 활용 탄막 - 주문불꽃 구체 생성'
        },
        {
          skill: skillData.arcaneBlast,
          desc: '비전 작렬 (필러)',
      ...
      priority: [
        {
          ...
          why: '명석함 3중첩 극대화 - 단일 대상과 동일 우선순위'
        },
        {
          skill: skillData.arcaneBarrage,
          desc: '직관 버프 탄막',
    ...
    mechanics: [
      {
        title: '비전 충전 관리',
        icon: '🔵',
        desc: '비전 충전 4중첩 유지 및 효율적 소모',
        details: [
          '비전 작렬: 비전 충전 +1 (최대 4중첩)',
          '비전 탄막: 비전 충전 모두 소모 (4중첩 시 최대 피해)',
          '중첩당 비전 작렬 피해 60% 증가',
          '최적 사이클: 작렬 4회 → 탄막 1회'
        ],
        why: '비전 충전 4중첩 유지로 DPS 극대화'
      },
      {
        title: '명석함 (Clearcasting)',
        icon: '✨',
        desc: '명석함 프록 관리 및 3중첩 극대화',
        details: [
          '비전 작렬 시전 시 명석함 발동 확률',
          '명석함: 비전 미사일/폭발 마나 소모 없음',
          '최대 3중첩까지 보유 가능 (15초 지속)',
          '3중첩 시 비전 미사일 사용 - 최대 효율'
        ],
        why: '명석함 3중첩 관리로 마나 효율 및 DPS 증가'
      },
      {
        title: '주문불꽃 구체 (성난태양)',
        icon: '🔥',
        desc: '주문불꽃 구체 생성 및 유지',
        details: [
          '비전 미사일, 비전 폭발 시전 시 생성',
          '최대 5개까지 생성 가능 (30초 지속)',
          '주기적으로 화염 피해 입힘',
          '티어 2세트: 주문불꽃 구체 피해 20% 증가'
        ],
        why: '주문불꽃 구체 최대 유지로 지속 피해 극대화'
      },
      {
        title: '마나 관리',
        icon: '💙',
        desc: '환기 및 마나 효율 극대화',
        details: [
          '환기: 6초 채널링으로 마나 60% 회복 (1.5분 쿨)',
          '비전 쇄도: 마나 재생 425% 증가 (15초 지속)',
          '명석함 활용: 무료 비전 미사일로 마나 절약',
          '최적 타이밍: 마나 30% 이하 시 환기 사용'
        ],
        why: '마나 고갈 방지 및 지속적인 DPS 유지'
      },
      {
        title: '마법사의 손길',
        icon: '🎯',
        desc: '12초 디버프 축적 및 폭발 피해',
        details: [
          '대상에게 12초 디버프 적용 (1.5분 쿨)',
          '디버프 기간 입힌 피해의 20% 축적',
          '12초 종료 시 축적 피해 폭발',
          '버스트 윈도우: 마법사의 손길 + 비전 쇄도 동시 사용'
        ],
        why: '버스트 타이밍 극대화 - 축적 피해 폭발로 DPS 증폭'
      }
    ]
  },
  spellslinger: {
...
const ArcaneMageGuide = () => {
  ...
  const [selectedTier, setSelectedTier] = useState('sunfury');  // 성난태양
  const [showToast, setShowToast] = useState(false);
  const [selectedBuild, setSelectedBuild] = useState('raid-single');
  const [selectedStatHero, setSelectedStatHero] = useState('sunfury');  // 성난태양
